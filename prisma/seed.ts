...
async function main() {
  ...
  const accountTypes = [
    ...
    // Agency Registration Entries - One per unique agency+jurisdiction combination
    // California
    {
      name: 'Agency Registration',
      scopeId: caScope!.id,
      agency: 'Employment Development Department (EDD)',
      description: 'Initial registration with EDD before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: caScope!.id,
      agency: 'California Department of Tax and Fee Administration (CDTFA)',
      description: 'Initial registration with CDTFA before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: caScope!.id,
      agency: 'Secretary of State',
      description: 'Initial registration with Secretary of State before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: caScope!.id,
      agency: 'Department of Industrial Relations',
      description: 'Initial registration with Department of Industrial Relations before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - California before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    // New York
    {
      ...
      scopeId: nyScope!.id,
      agency: 'Department of Labor',
      description: 'Initial registration with Department of Labor before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: nyScope!.id,
      agency: 'Department of Taxation and Finance',
      description: 'Initial registration with Department of Taxation and Finance before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: nyScope!.id,
      agency: 'Department of State',
      description: 'Initial registration with Department of State before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - New York before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    // Texas
    {
      ...
      scopeId: txScope!.id,
      agency: 'Texas Workforce Commission',
      description: 'Initial registration with Texas Workforce Commission before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: txScope!.id,
      agency: 'Texas Comptroller of Public Accounts',
      description: 'Initial registration with Texas Comptroller of Public Accounts before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
    ...
    },
    {
      ...
      description: 'Initial registration with Test Agency - Texas before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    // Florida
    {
      ...
      scopeId: flScope!.id,
      agency: 'Department of Revenue',
      description: 'Initial registration with Department of Revenue before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      scopeId: flScope!.id,
      agency: 'Division of Corporations',
      description: 'Initial registration with Division of Corporations before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - Florida before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    // Washington
    {
      ...
      scopeId: waScope!.id,
      agency: 'Employment Security Department',
      description: 'Initial registration with Employment Security Department before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
    ...
    },
    {
      ...
      description: 'Initial registration with Test Agency - Washington before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    // Additional Test Agencies
    {
      name: 'Agency Registration',
      scopeId: ilScope!.id,
      agency: 'Test Agency - Illinois',
      description: 'Initial registration with Test Agency - Illinois before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - Ohio before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - Pennsylvania before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - Georgia before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - North Carolina before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - Michigan before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
    {
      ...
      description: 'Initial registration with Test Agency - New Jersey before other filings',
      requiredFields: JSON.stringify(['entityName', 'registrationNumber', 'filingDate']),
      defaultDuration: '0',
    },
